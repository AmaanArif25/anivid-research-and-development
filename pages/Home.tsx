...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white selection:bg-blue-100 overflow-x-hidden">
      {/* Cinematic Hero */}
      <section className="relative hero-min-height flex flex-col items-center justify-center overflow-hidden section">
        <motion.div 
          style={{ y: yText, opacity }}
          className="z-10 text-center max-w-5xl container"
        >
          <motion.div
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
          ...
          <motion.h1 
            ...
            className="text-responsive-5xl font-serif text-slate-900 leading-[1.1] tracking-tight mb-6 md:mb-8"
          >
          ...
          <motion.p
            ...
            className="text-responsive-base text-slate-600 font-light leading-relaxed max-w-2xl mx-auto mb-8 md:mb-12 text-justify-pro p-responsive"
          >
          ...
          >
            <Link to="/services" className="btn-responsive w-full sm:w-auto bg-slate-900 text-white text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-blue-700 transition-all shadow-md text-center focus-ring">
              Explore Tech
            </Link>
            <Link to="/contact" className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] border-b border-slate-900 pb-1 hover:text-blue-700 hover:border-blue-700 transition-all focus-ring">
              Partner With Us
            </Link>
          </motion.div>
        </motion.div>
      ...
      <section className="section border-t border-slate-50">
        <div className="container">
          <div className="grid-responsive lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="space-y-6">
              ...
              <h2 className="text-responsive-3xl font-serif leading-tight tracking-tight">Who We Are</h2>
              <p className="text-responsive-base text-slate-500 font-light leading-relaxed text-justify-pro">
              ...
              <div className="pt-4">
                <Link to="/about" className="btn-responsive border border-slate-200 text-[9px] font-bold uppercase tracking-[0.3em] hover:bg-slate-50 transition-all focus-ring">
                  About Founder
                </Link>
              </div>
            </motion.div>
